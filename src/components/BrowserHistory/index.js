...
const initialHistoryList = [
  ...
  },
  {
    ...
    title: 'HTML is used for build websites',
    domainUrl: 'html.com',
    link: 'https://www.w3schools.com/howto/howto_website.asp',
  },

  {
    ...
    title: 'GitHub is code hosting platform for version control',
    domainUrl: 'github.com/',
  ...
  },
  {
    ...
    title: 'GeeksForGeeks is a Computer Science portal',
    domainUrl: 'geeksforgeeks.org',
      ...
      <div className="app-container">
        <div className="bg-container">
          <div className="top-container">
            <a
              href="https://satishmocknxt1.ccbp.tech/"
              rel="noreferrer"
              target="_self"
            >
              <img
